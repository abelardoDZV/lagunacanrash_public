(function () {
    ...
    var TRANSLATIONS = {
        es: {
            ...
            'rest.room2': '<strong>Ambiente intermedio</strong> — junto a la carretera, cerrado para resguardarse del viento; más vista a la pista que a la laguna.',
            'rest.room3': '<strong>Salón panorámico</strong> — pared transparente con vista total a la laguna (un plástico resistente que simula vidrio, instalado con ingenio y poco presupuesto).',
            ...
            'rest.diningAlt': 'Comedor con pared panorámica transparente y vista completa a la laguna',
        ...
        en: {
            ...
            'rest.room2': '<strong>Intermediate area</strong> — next to the road, enclosed to shelter from the wind; more view of the road than the lagoon.',
            'rest.room3': '<strong>Panoramic hall</strong> — transparent wall with full lagoon view (a sturdy plastic that mimics glass, installed with ingenuity and a modest budget).',
            ...
            'rest.diningAlt': 'Dining room with panoramic transparent wall and full lagoon view',
