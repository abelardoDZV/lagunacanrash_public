(function () {
    ...
    var TRANSLATIONS = {
        es: {
            'meta.title': 'Laguna Canrash | Una escapada a la altura en Áncash',
            'meta.description': 'Planea una escapada a Laguna Canrash: paisaje andino, trucha de crianza propia, restaurante, hospedaje rústico y ruta asfaltada en San Marcos, Áncash.',
            'meta.ogDescription': 'Laguna, trucha y descanso en los Andes de Áncash. Conoce la ruta, el restaurante y el hospedaje para planear tu visita.',
            'meta.twitterDescription': 'Laguna, trucha y descanso en los Andes de Áncash. Planea tu visita a Laguna Canrash.',
            ...
            'hero.title': 'Una escapada a la altura',
            'hero.subtitle': 'Laguna, trucha y descanso en los Andes de Áncash. Ven por el paisaje, prueba nuestra trucha y quédate a vivir Canrash con calma.',
            'hero.ctaRoute': 'Cómo llegar',
            'hero.ctaRestaurant': 'Ver restaurante',
            'hero.ctaReserve': 'Planea tu visita',
            'hero.ctaExperience': 'Descubre la experiencia',
            ...
            'experience.label': 'Una experiencia completa',
            'experience.title': 'Ven por el paisaje. Quédate por todo lo demás.',
            'experience.intro': 'Canrash reúne alta montaña, trucha criada en la propia laguna, comida honesta y un lugar sencillo donde descansar.',
            'experience.landscapeLabel': 'Paisaje',
            'experience.landscapeTitle': 'Alta montaña y agua viva',
            'experience.foodLabel': 'Origen',
            'experience.foodTitle': 'De la laguna a tu mesa',
            'experience.restLabel': 'Descanso',
            'experience.restTitle': 'Hospitalidad a la altura',
            'experience.routeLabel': 'Camino',
            'experience.routeTitle': 'La ruta también se vive',
            ...
            'rest.label': 'Origen y cocina',
            'rest.title': 'De la laguna a tu mesa',
            ...
            'serv.label': 'Hospedaje y servicios',
            'serv.title': 'Completa tu escapada',
            'serv.intro': 'Descansa frente a los Andes, deja tu vehículo con tranquilidad y aprovecha una conexión estable incluso a más de 4 000 m.',
            ...
            'contact.tagline': 'Laguna, trucha y descanso en los Andes de Áncash.',
            ...
            'wa.general': 'Hola, quisiera planear una visita a Laguna Canrash',
            'wa.reserve': 'Hola, quiero planear una visita a Laguna Canrash. ¿Podrían ayudarme con la ruta, el restaurante y el hospedaje?',
            'wa.menu': 'Hola, quiero consultar la carta del restaurante',
            'wa.wholesale': 'Hola, quiero cotizar trucha al por mayor'
        },
        en: {
            'meta.title': 'Laguna Canrash | A high-altitude Andean escape',
            'meta.description': 'Plan an escape to Laguna Canrash: Andean landscape, trout from our own farm, restaurant, rustic lodging and a paved road in San Marcos, Áncash.',
            'meta.ogDescription': 'Lagoon, trout and rest in the Andes of Áncash. Explore the route, restaurant and lodging to plan your visit.',
            'meta.twitterDescription': 'Lagoon, trout and rest in the Andes of Áncash. Plan your visit to Laguna Canrash.',
            ...
            'hero.title': 'An escape at altitude',
            'hero.subtitle': 'Lagoon, trout and rest in the Andes of Áncash. Come for the landscape, taste our trout and stay to experience Canrash at an unhurried pace.',
            'hero.ctaRoute': 'How to get here',
            'hero.ctaRestaurant': 'See restaurant',
            'hero.ctaReserve': 'Plan your visit',
            'hero.ctaExperience': 'Discover the experience',
            ...
            'experience.label': 'A complete experience',
            'experience.title': 'Come for the landscape. Stay for everything else.',
            'experience.intro': 'Canrash brings together high mountains, trout raised in the lagoon, honest food and a simple place to rest.',
            'experience.landscapeLabel': 'Landscape',
            'experience.landscapeTitle': 'High mountains and living water',
            'experience.foodLabel': 'Origin',
            'experience.foodTitle': 'From the lagoon to your table',
            'experience.restLabel': 'Rest',
            'experience.restTitle': 'Hospitality at altitude',
            'experience.routeLabel': 'Journey',
            'experience.routeTitle': 'The road is part of it',
            ...
            'rest.label': 'Origin and cooking',
            'rest.title': 'From the lagoon to your table',
            ...
            'serv.label': 'Lodging and services',
            'serv.title': 'Complete your escape',
            'serv.intro': 'Rest facing the Andes, leave your vehicle with peace of mind and stay connected even above 4,000 m.',
            ...
            'contact.tagline': 'Lagoon, trout and rest in the Andes of Áncash.',
            ...
            'wa.general': 'Hello, I would like to plan a visit to Laguna Canrash',
            'wa.reserve': 'Hello, I would like to plan a visit to Laguna Canrash. Could you help me with the route, restaurant and lodging?',
